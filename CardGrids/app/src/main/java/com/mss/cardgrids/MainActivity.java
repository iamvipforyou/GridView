...
public class MainActivity extends AppCompatActivity {
    ...
    RecyclerView rcGrid;
    ArrayList<Movie> mInTheaterMovieList = new ArrayList<>();
    MyAdapter adapter;
...
//Can change rows and columns accordingly changing the value
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, false);
        rcGrid.setLayoutManager(gridLayoutManager);

        adapter = new MyAdapter(MainActivity.this, mInTheaterMovieList);
        rcGrid.setAdapter(adapter);
        rcGrid.setHasFixedSize(true);
        rcGrid.setNestedScrollingEnabled(false);
    ...
    void addSampleContent() {
        ...
        mInTheaterMovieList.add(new Movie("Wonder Woman",
        ...
        mInTheaterMovieList.add(new Movie("Transformers5",
        ...
        mInTheaterMovieList.add(new Movie("Justice League",
        ...
        mInTheaterMovieList.add(new Movie("The Mummy",
        ...
        mInTheaterMovieList.add(new Movie("Kong: Skull Island",
        ...
        mInTheaterMovieList.add(new Movie("Spider Man",
        ...
        mInTheaterMovieList.add(new Movie("Furious 8",
        ...
        mInTheaterMovieList.add(new Movie("Dunkirk",
